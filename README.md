...
master: [![Build Status](https://travis-ci.com/sphinxlab/toulbar2.svg?branch=master)](https://travis-ci.com/sphinxlab/toulbar2)
cpd: [![Build Status](https://travis-ci.com/sphinxlab/toulbar2.svg?branch=cpd)](https://travis-ci.com/sphinxlab/toulbar2) [![Language grade: C/C++](https://img.shields.io/lgtm/grade/cpp/g/sphinxlab/toulbar2.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/sphinxlab/toulbar2/context:cpp)[![PyPi version](https://img.shields.io/pypi/v/pytoulbar2.svg)](https://pypi.org/project/pytoulbar2)[![PyPi wheel](https://img.shields.io/pypi/wheel/pytoulbar2.svg)](https://pypi.org/project/pytoulbar2)[![PyPi python versions](https://img.shields.io/pypi/pyversions/pytoulbar2.svg)](https://pypi.org/project/pytoulbar2)
